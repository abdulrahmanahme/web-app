...
class HiderWebWidget extends StatelessWidget {
...
class TabWebBarWidget extends StatefulWidget {
  const TabWebBarWidget({
    super.key,
  });

  @override
  State<TabWebBarWidget> createState() => _TabWebBarWidgetState();
}

class _TabWebBarWidgetState extends State<TabWebBarWidget> {
  int selectedItem = 0;
  @override
  Widget build(BuildContext context) {
    return SizedBox(
